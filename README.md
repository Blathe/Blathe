...
#### :rocket: Agentic Engineer - :robot: Tech Enthusiast - :fish: Outdoorsman
...
🖥️ [pview](https://github.com/Blathe/pview): Terminal UI for monitoring a single process's CPU, memory, and disk I/O in real time — think htop, scoped to one process.
